...
The Rigging Equipment section documents the standardized procedures for preparing, inspecting,
handling, deploying, maintaining, and storing all **rigging-specific equipment** used by Maryland
Productions (MP) and Event Revolution (RV). Rigging equipment is safety-critical and must always be
handled with strict adherence to inspection, rating, and usage standards.

These SOPs ensure rigging equipment is safe to use, properly documented, and returned to service
only when it meets MP/RV safety requirements.
...
1. **Prep & Inspection**
   ...
   - Verification of ratings and markings
   - Removal of unsafe equipment
   - Packing by system and job

2. **Deployment**
   - Transport to site
   - Installation by qualified personnel
   - Verification before load is applied

3. **Operation**
   - Monitoring during use
   - Environmental awareness (wind, load changes)
   - Immediate response to unsafe conditions

4. **Strike & Return**
   - Controlled de-rigging
   - Inspection during strike
   - Scanning back into inventory

5. **Reset & Maintenance**
   - Cleaning and inspection
   - Repair or retirement decisions
   - Documentation and re-tagging
   - Return to approved storage
