...
The Power Equipment section documents the standardized procedures for preparing, handling,
deploying, maintaining, and storing all **power distribution equipment** used by Maryland
Productions (MP) and Event Revolution (RV). Power equipment is safety-critical and must be handled
only by trained personnel following strict inspection, connection, and load-planning standards.

These SOPs ensure power systems are deployed safely, operate reliably, and return to the warehouse
...
1. **Prep & Inspection**
   - Visual inspection of cable jackets and connectors
   - Verification of ratings and labeling
...
3. **Operation**
   ...
   - Load verification and breaker management
   - Immediate response to unsafe conditions

4. **Strike & Return**
   - Controlled de-energization and disconnection
